...
export const metadata: Metadata = {
  title: "Bulk Background Remover for eBay Listings — Clean Product Photos Fast",
  description: "Remove backgrounds from all your eBay listing photos in one batch. Clean white backgrounds help your listings stand out and sell faster. 5 free images to start.",
  alternates: {
    canonical: "https://backdropimage.com/ebay-sellers",
  },
  openGraph: {
    title: "Bulk Background Remover for eBay Listings — Clean Product Photos Fast",
    description: "Remove backgrounds from all your eBay listing photos in one batch. Clean white backgrounds help your listings stand out and sell faster.",
  ...
  twitter: {
    ...
    title: "Bulk Background Remover for eBay Listings — Clean Product Photos Fast",
    description: "Remove backgrounds from all your eBay listing photos in one batch. 5 free images to start.",
  },
};

const BULLETS = [
  "Process your entire eBay inventory at once",
  "White or transparent backgrounds",
  "No Photoshop skills needed",
  "Download ZIP, original filenames preserved",
  "From $19/month — unlimited images on Starter plan",
];

const FAQS = [
  {
    q: "How many eBay photos can I process?",
    a: "Backdrop handles up to 500 images per batch. Monthly plans start at 1,000 images/month, so you can process your entire eBay inventory across multiple batches in a single month.",
  },
  {
    q: "What background color options are there?",
    a: "White (#FFFFFF) and transparent PNG. White is recommended for most eBay listings as it looks clean and professional across all device types and eBay's search results.",
  },
  {
    q: "Will it work on clothing and apparel photos?",
    a: "Yes. Backdrop handles clothing, shoes, accessories, electronics, and most product categories. The AI is trained on diverse product types common in eBay listings.",
  },
];
      ...
      <main className="pt-24">
        ...
        <section className="mx-auto max-w-4xl px-6 pt-16 pb-20 text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-border bg-secondary/30 px-4 py-1.5 text-sm text-muted-foreground mb-6">
            <span>🛍️</span>
            <span>Built for eBay sellers</span>
          </div>
          <h1 className="text-4xl font-bold tracking-tight leading-tight sm:text-5xl md:text-6xl mb-6">
            Bulk Background Remover<br />
            <span className="text-muted-foreground">for eBay Sellers</span>
          </h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
            Clean, professional product photos get more clicks. Remove backgrounds from your entire eBay inventory in minutes — not hours.
          </p>
          <Link
            href="/sign-up"
        ...
        <section className="border-t border-border py-20 px-6 bg-secondary/10">
          <div className="mx-auto max-w-3xl">
            <h2 className="text-2xl font-bold tracking-tight text-center mb-10">
              Everything eBay sellers need for professional photos
            </h2>
          ...
          <div className="mx-auto max-w-2xl text-center">
            <div className="rounded-2xl border border-border bg-card p-8">
              ...
              <p className="text-xl text-foreground leading-relaxed mb-4">
                &ldquo;I have 1,200+ listings. This saved me weeks of editing time.&rdquo;
              </p>
              <p className="text-sm text-muted-foreground">— eBay seller</p>
            </div>
          </div>
        </section>
        ...
        <section className="border-t border-border py-20 px-6 bg-secondary/10">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-2xl font-bold tracking-tight mb-10">Clean listing photos in three steps</h2>
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { step: "1", title: "Upload your photos", desc: "Drop up to 500 product photos at once — JPG, PNG, or WEBP." },
                { step: "2", title: "AI removes backgrounds", desc: "Clean white or transparent backgrounds in ~2 seconds per image. No editing skills needed." },
                { step: "3", title: "Download and list", desc: "All processed photos in a ZIP. Original filenames preserved — ready to upload to eBay." },
              ].map((item) => (
        ...
        <section className="border-t border-border py-24 px-6 text-center">
          <div className="mx-auto max-w-2xl">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6">
              Start cleaning up your eBay photos today
            </h2>
